...
import com.example.android.cryptoinfo.databinding.GridViewItemBinding
...
class PhotoGridAdapter :
    ListAdapter<Coins, PhotoGridAdapter.CoinsViewHolder>(DiffCallback) {

    /**
     * The MarsPhotosViewHolder constructor takes the binding variable from the associated
     * GridViewItem, which nicely gives it access to the full [CryptoInfo] information.
     */
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PhotoGridAdapter.CoinsViewHolder {
        return PhotoGridAdapter.CoinsViewHolder(
